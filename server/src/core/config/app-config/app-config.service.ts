...
import { APP_CONFIG_VARIABLES, AppConfig, AppConfigId, AppConfigInfo, ConfigType } from '../config.model';
import { MapUtils } from '../../util/map-utils';
import { ConfigException, ConfigUtils } from '../../util/config-utils';
import { INIT_LOG_PREFIX } from '../../init.model';

/**
 * Service to manage application level (global) variables.
 *
 * Variables are cached here, variables can be changed, but changes are not persisted.
 *
 * ########################################################################################
...
export class AppConfigService {
  ...
  /**
   * Initial loading of variables into the cache from .env.
   *
