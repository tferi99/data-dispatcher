...
export enum AppConfigId {
  ...
  TraceTradersData = 'TRACE_TRADERS_DATA',
...
export const APP_CONFIG_VARIABLES: AppConfigInfo[] = [
  ...
  { configId: AppConfigId.TraceTraders, type: ConfigType.Boolean },
  ...
  { configId: AppConfigId.TraceTradersData, type: ConfigType.Boolean },
...
export enum UserConfigId {
  ...
  TestStringForTrader = 'TEST_STRING_FOR_TRADER',
  TestNumberForTrader = 'TEST_NUMBER_FOR_TRADER',
  TestArrayForTrader = 'TEST_ARRAY_FOR_TRADER',
  TestObjectForTrader = 'TEST_OBJECT_FOR_TRADER',
...
export const USER_CONFIG_VARIABLES: UserConfigInfo[] = [
  ...
  { configId: UserConfigId.TestStringForTrader, type: ConfigType.String },
  { configId: UserConfigId.TestNumberForTrader, type: ConfigType.Number },
  { configId: UserConfigId.TestArrayForTrader, type: ConfigType.Array },
  { configId: UserConfigId.TestObjectForTrader, type: ConfigType.Object },
